...
public interface CommentRepository extends JpaRepository<CommentEntity, Integer> {
    ...
    @Query("SELECT c FROM CommentEntity c LEFT JOIN FETCH c.childComments WHERE c.song.song_id = :songId AND c.parentComment IS NULL ORDER BY c.time_rated DESC")
